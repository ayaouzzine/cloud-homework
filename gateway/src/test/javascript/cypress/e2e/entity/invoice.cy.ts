...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = {
    date: '2023-01-31T07:35:37.470Z',
    status: 'PAID',
    paymentMethod: 'PAYPAL',
    paymentDate: '2023-01-31T06:32:08.622Z',
    paymentAmount: 4928,
  };
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      cy.get(`[data-cy="date"]`).type('2023-01-30T20:05').blur().should('have.value', '2023-01-30T20:05');
      ...
      cy.get(`[data-cy="paymentDate"]`).type('2023-01-31T02:33').blur().should('have.value', '2023-01-31T02:33');
