...
describe('Notification e2e test', () => {
  ...
  const notificationSample = {
    date: '2023-01-31T08:13:06.457Z',
    sentDate: '2023-01-31T08:40:09.531Z',
    format: 'EMAIL',
    userId: 20600,
    productId: 75536,
  };
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      cy.get(`[data-cy="date"]`).type('2023-01-30T15:42').blur().should('have.value', '2023-01-30T15:42');

      cy.get(`[data-cy="details"]`).type('firewall multimedia').should('have.value', 'firewall multimedia');

      cy.get(`[data-cy="sentDate"]`).type('2023-01-31T01:21').blur().should('have.value', '2023-01-31T01:21');
