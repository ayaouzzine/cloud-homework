...
describe('ProductOrder e2e test', () => {
  ...
  const productOrderSample = { placedDate: '2023-01-31T11:39:08.294Z', status: 'CANCELLED', code: 'Buckinghamshire' };
  ...
  describe('ProductOrder page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('last delete button click should delete instance of ProductOrder', () => {
        cy.intercept('GET', '/services/productorder/api/product-orders/*').as('dialogDeleteRequest');
  ...
  describe('new ProductOrder page', () => {
    ...
    it('should create an instance of ProductOrder', () => {
      cy.get(`[data-cy="placedDate"]`).type('2023-01-31T05:50').blur().should('have.value', '2023-01-31T05:50');
