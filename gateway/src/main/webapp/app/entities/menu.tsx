  ...
  return (
    <>
      ...
      <MenuItem icon="asterisk" to="/product">
        <Translate contentKey="global.menu.entities.productorderProduct" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/product-category">
        <Translate contentKey="global.menu.entities.productorderProductCategory" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/customer">
        <Translate contentKey="global.menu.entities.productorderCustomer" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/product-order">
        <Translate contentKey="global.menu.entities.productorderProductOrder" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/order-item">
        <Translate contentKey="global.menu.entities.productorderOrderItem" />
      </MenuItem>
