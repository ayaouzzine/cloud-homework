...
export const ProductOrder = () => {
  ...
  const productOrderList = useAppSelector(state => state.gateway.productOrder.entities);
  const loading = useAppSelector(state => state.gateway.productOrder.loading);
  const totalItems = useAppSelector(state => state.gateway.productOrder.totalItems);
  ...
  return (
    <div>
      <h2 id="product-order-heading" data-cy="ProductOrderHeading">
        <Translate contentKey="gatewayApp.productorderProductOrder.home.title">Product Orders</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gatewayApp.productorderProductOrder.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/product-order/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.productorderProductOrder.home.createLabel">Create new Product Order</Translate>
          </Link>
        </div>
      </h2>
        ...
        {productOrderList && productOrderList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gatewayApp.productorderProductOrder.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="gatewayApp.productorderProductOrder.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="gatewayApp.productorderProductOrder.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="gatewayApp.productorderProductOrder.customer">Customer</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayApp.productorderProductOrder.home.notFound">No Product Orders found</Translate>
            </div>
          )
        )}
      </div>
