...
import { getEntities as getCustomers } from 'app/entities/productorder/customer/customer.reducer';
...
export const ProductOrderUpdate = () => {
  ...
  const updating = useAppSelector(state => state.gateway.productOrder.updating);
  const updateSuccess = useAppSelector(state => state.gateway.productOrder.updateSuccess);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.productorderProductOrder.home.createOrEditLabel" data-cy="ProductOrderCreateUpdateHeading">
            <Translate contentKey="gatewayApp.productorderProductOrder.home.createOrEditLabel">Create or edit a ProductOrder</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gatewayApp.productorderProductOrder.placedDate')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.productorderProductOrder.status')}
              ...
              >
                {orderStatusValues.map(orderStatus => (
                  <option value={orderStatus} key={orderStatus}>
                    {translate('gatewayApp.OrderStatus.' + orderStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('gatewayApp.productorderProductOrder.invoiceId')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.productorderProductOrder.code')}
              ...
              <ValidatedField
                ...
                name="customer"
                data-cy="customer"
                label={translate('gatewayApp.productorderProductOrder.customer')}
                type="select"
              >
                <option value="" key="0" />
                {customers
