...
export const ProductOrderDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.productorderProductOrder.delete.question">
        <Translate contentKey="gatewayApp.productorderProductOrder.delete.question" interpolate={{ id: productOrderEntity.id }}>
