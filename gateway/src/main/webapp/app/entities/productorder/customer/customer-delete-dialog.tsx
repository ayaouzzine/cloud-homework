...
export const CustomerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.productorderCustomer.delete.question">
        <Translate contentKey="gatewayApp.productorderCustomer.delete.question" interpolate={{ id: customerEntity.id }}>
