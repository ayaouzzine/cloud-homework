...
export const OrderItemDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.productorderOrderItem.delete.question">
        <Translate contentKey="gatewayApp.productorderOrderItem.delete.question" interpolate={{ id: orderItemEntity.id }}>
