...
export const ProductCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.productorderProductCategory.delete.question">
        <Translate contentKey="gatewayApp.productorderProductCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
