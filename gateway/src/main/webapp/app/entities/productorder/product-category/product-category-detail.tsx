    ...
    <Row>
      <Col md="8">
        <h2 data-cy="productCategoryDetailsHeading">
          <Translate contentKey="gatewayApp.productorderProductCategory.detail.title">ProductCategory</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="gatewayApp.productorderProductCategory.name">Name</Translate>
            </span>
          </dt>
