...
import { IProductCategory, defaultValue } from 'app/shared/model/productorder/product-category.model';
...
const apiUrl = 'services/productorder/api/product-categories';
