  ...
  return (
    <div>
      <h2 id="product-heading" data-cy="ProductHeading">
        <Translate contentKey="gatewayApp.productorderProduct.home.title">Products</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gatewayApp.productorderProduct.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/product/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.productorderProduct.home.createLabel">Create new Product</Translate>
          </Link>
        </div>
      </h2>
        ...
        {productList && productList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gatewayApp.productorderProduct.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('sku')}>
                  <Translate contentKey="gatewayApp.productorderProduct.sku">Sku</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('upc')}>
                  <Translate contentKey="gatewayApp.productorderProduct.upc">Upc</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="gatewayApp.productorderProduct.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="gatewayApp.productorderProduct.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('price')}>
                  <Translate contentKey="gatewayApp.productorderProduct.price">Price</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('colors')}>
                  <Translate contentKey="gatewayApp.productorderProduct.colors">Colors</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('image')}>
                  <Translate contentKey="gatewayApp.productorderProduct.image">Image</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('imageSha1')}>
                  <Translate contentKey="gatewayApp.productorderProduct.imageSha1">Image Sha 1</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('imageCdnUrl')}>
                  <Translate contentKey="gatewayApp.productorderProduct.imageCdnUrl">Image Cdn Url</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('thumbnailSha1')}>
                  <Translate contentKey="gatewayApp.productorderProduct.thumbnailSha1">Thumbnail Sha 1</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('thumbnailCdnUrl')}>
            ...
            <tbody>
              {productList.map((product, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{product.price}</td>
                  <td>
                    <Translate contentKey={`gatewayApp.ProductSize.${product.productSize}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayApp.productorderProduct.home.notFound">No Products found</Translate>
            </div>
          )
        )}
      </div>
