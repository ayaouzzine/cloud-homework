...
export const ProductDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.productorderProduct.delete.question">
        <Translate contentKey="gatewayApp.productorderProduct.delete.question" interpolate={{ id: productEntity.id }}>
