    ...
    <Row>
      <Col md="8">
        <h2 data-cy="notificationDetailsHeading">
          <Translate contentKey="gatewayApp.notificationNotification.detail.title">Notification</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="date">
              <Translate contentKey="gatewayApp.notificationNotification.date">Date</Translate>
            </span>
          </dt>
          <dd>{notificationEntity.date ? <TextFormat value={notificationEntity.date} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="details">
              <Translate contentKey="gatewayApp.notificationNotification.details">Details</Translate>
            </span>
          </dt>
          <dd>{notificationEntity.details}</dd>
          <dt>
            <span id="sentDate">
              <Translate contentKey="gatewayApp.notificationNotification.sentDate">Sent Date</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="format">
              <Translate contentKey="gatewayApp.notificationNotification.format">Format</Translate>
            </span>
          </dt>
          <dd>{notificationEntity.format}</dd>
          <dt>
            <span id="userId">
              <Translate contentKey="gatewayApp.notificationNotification.userId">User Id</Translate>
            </span>
          </dt>
