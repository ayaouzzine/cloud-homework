...
export const NotificationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.notificationNotification.delete.question">
        <Translate contentKey="gatewayApp.notificationNotification.delete.question" interpolate={{ id: notificationEntity.id }}>
