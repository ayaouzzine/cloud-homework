            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gatewayApp.invoiceShipment.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('trackingCode')}>
                  <Translate contentKey="gatewayApp.invoiceShipment.trackingCode">Tracking Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
